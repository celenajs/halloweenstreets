...
class ET_Core_SupportCenter {
	 ...
	 *
	 * @since ?? Added check to verify the Administrator Role exists before attempting to run `add_cap()`.
	 * @since 3.28
	 */
	 ...
	 *
	 * @since ?? Added check to verify the Administrator Role exists before attempting to run `remove_cap()`.
	 * @since 3.28
	 */
